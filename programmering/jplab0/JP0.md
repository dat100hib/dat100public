...
7. Modifiser programmet slik det skriver ut en linje med 10 stjerner (`*`) før og etter selve teksten.
8. Kjør programmet fra punkt 7. Når programmet fungerer lag skjerm-bilde tilsvarende bildet ovenfor. Skjerm-bildet skal leveres inn i Canvas som svar på oppgaven.
